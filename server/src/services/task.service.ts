...
import TaskValidation, { TaskCreate, TaskDelete, TaskUpdate } from "../validations/task.validation";
...
export default class TaskService {
    ...
    static async findAll(filter: any) {
        ...
        const { project_id, assigned_id, status, search, page=defaultPage, limit = defaultLimit} = validData;
